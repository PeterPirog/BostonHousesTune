...
if __name__ == "__main__":
    ...
    analysis = tune.run(
        ...
        config={
            ...
            # output layers
            "hidden_conv": tune.randint(16, 151),
    ...
    #tensorboard --logdir /home/peterpirog/PycharmProjects/BostonHousesTune/ray_results/exp_cnn --bind_all

    """
    Current best trial: f2e40_00965 with _metric=0.19754671305418015 and 
    parameters={'rare_tol': 0.01, 'n_categories': 2,     'max_iter': 20, 'iter_tol': 0.001, 'n_components': 0.999,
     'batch': 8, 'lr': 0.01,
     'filter1': 32, 'kernel1': 7, 'activation_c1': 'elu', 'dropout_c1': 0.24,
     'filter2': 16,'kernel2': 11, 'activation_c2': 'elu',
     'filter3': 64,'kernel3': 5, 'activation_c3': 'elu', 'dropout_c3': 0.1,
       'hidden_conv': 23,'activation_hidden_conv': 'elu', 'activation_output': 'linear'}
    """